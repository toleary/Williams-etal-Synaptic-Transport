...
We develop a biophysically-rooted model of microtubule transport, and show how it can sustain arbitrarily complex distributions of cargo using simple, localized biochemical processes.
...
% final sentence is the same as that of the intro. Should paraphrase, but this could be the most important finding so it should be in both.
...
% BUT: is detachment and convergence to a target distribution sensitive to this?
